...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="index.html">Dugen</a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <!-- <li class="dropdown"><a href="./medicine.html"><span>Medicine</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
  ...
  <section class="inner-page"> <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 mb-3">
        <img src="./assets/img/uddhav_dog.jpg" alt="" class="fluid img-thumbnail">      
      </div>
      <div class="col-sm-6 col-md-4 mb-3">
