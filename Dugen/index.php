        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>products</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <!-- <li class="dropdown"><a href="./medicine.html"><span>Insert Medicines</span> <i class="bi bi-chevron-right"></i></a> -->
              <!-- <ul>
                  <li><a href="./forms/insertcaps.php">CAPSULES</a></li>
                  <li><a href="./forms/inserttablet.php">TABLETS</a></li>
                  <li><a href="./forms/insertoral.php">ORAL LIQUIDS</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center-left">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center-left">
          <h1>Wellness thorugh research & developement</h1>
          <h2>We are diligently and sustainably achieving
            excellence in all that we do</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <p class="Futura">
              ABOUT US
              Dugen Pharma is a leading Pharma company in India, dealing with a large variety of Pharmaceutical products
              and Medical devices. Our company is a pioneer in providing the best products to all at a reasonable price.
              ...
              Pharma Marketing background, we have successfully made an impact on Pharmaceutical sector of India in all
